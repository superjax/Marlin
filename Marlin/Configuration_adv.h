...
//#define BACKLASH_COMPENSATION
  ...
  //#define BACKLASH_GCODE
    ...
    // Measure the Z backlash when probing (PROBE_OFFSET_WIZARDPROBE_OFFSET_WIZARD) and set with "M425 Z"
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.025       // (mm) Compression length applying to all extruders
  #endif
