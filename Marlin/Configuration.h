...
#define STRING_CONFIG_H_AUTHOR "(James Jackson)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "James' Ender 3 Pro (4.2.7)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20.3, -51.3, -1.55 }
